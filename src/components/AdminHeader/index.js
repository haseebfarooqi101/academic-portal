...
export default function AdminHeader({ activeItem, breadcrumbs = [], setActiveItem, onToggleSidebar, isMobile, isSidebarOpen }) {
                ...
                <div className="p-4 space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">John Doe submitted application</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                    <div>
                      <p className="text-sm text-gray-900">Teacher approved</p>
                      <p className="text-xs text-gray-500">Sarah Smith account activated</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-yellow-500 rounded-full mt-2"></div>
                    <div>
                      <p className="text-sm text-gray-900">System maintenance</p>
