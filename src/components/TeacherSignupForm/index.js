...
import { useTeacherSignupValidation } from "../../hooks/useTeacherSignupValidation";
...
export default function TeacherSignupForm() {
  ...
  const { formData, error } = useSelector((state) => state.teacherSignup);
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const required = ["name", "email", "password", "confirmPassword", "department"];
