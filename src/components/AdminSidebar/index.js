...
export default function AdminSidebar({ activeItem, setActiveItem, isOpen, isMobile, onClose, onToggle, isCollapsed: externalIsCollapsed }) {
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2 text-left transition-all duration-200 ${
                  activeItem === item.id
                    ? 'hover:bg-opacity-90'
                    : 'hover:bg-gray-50'
                } ${isCollapsed ? 'justify-start pl-6' : ''}`}
