...
export default function TeacherHeader({ activeItem, breadcrumbs = [], setActiveItem, onToggleSidebar, isMobile, isSidebarOpen }) {
  ...
  const getPageTitle = () => {
    switch (activeItem) {
      ...
      case 'leaves': return 'Leave Approval';
                ...
                <div className="p-4 space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">John Doe submitted Math homework</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                    <div>
                      <p className="text-sm text-gray-900">Class scheduled</p>
                      <p className="text-xs text-gray-500">Physics Lab - Tomorrow 10:00 AM</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-yellow-500 rounded-full mt-2"></div>
                    <div>
                      <p className="text-sm text-gray-900">Grade deadline</p>
                      <p className="text-xs text-gray-500">Submit grades by Friday</p>
                    </div>
                  </div>
                </div>
              </div>
