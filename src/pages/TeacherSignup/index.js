  ...
  const getContainerStyles = () => {
    if (isMobile) {
      ...
      return {
        ...
        cardClass: "w-[520px] bg-white rounded-t-2xl border border-gray-200 shadow-lg flex flex-col h-[calc(100vh-32px)] max-h-[672px] p-8 gap-6 overflow-hidden",
        contentClass: "flex flex-col items-center w-full flex-1 min-h-0",
        headerGap: '16px',
      ...
      return {
        ...
        cardClass: "w-[520px] bg-white rounded-t-2xl border border-gray-200 shadow-lg flex flex-col h-[calc(100vh-64px)] max-h-[672px] p-12 gap-8 overflow-hidden",
        contentClass: "flex flex-col items-center w-full flex-1 min-h-0",
        headerGap: '16px',
        logoSize: { width: '280px', height: '70px' },
        titleSize: '20px',
    ...
    <div className={styles.containerClass}>
      <div className={styles.cardClass}>
        <div className={styles.contentClass}>
          ...
          {/* Header: Logo + Title + Tabs — fixed, does not grow */}
